...
public interface ProxyInfo {
    ...
    /**
     * Return if the proxying request is a WebSocketRequest or not
     * @return true if underlying is proxying a WebSocket request
     */
    default boolean isWebSocketRequest() {
        return false;
    }
}
